...
methods Kelletube calls in it's lifecycle.
...
For this specific endpoint, you may need `WebView` or `Forms` to get user inputs. The [`hetu_kelletube_plugin`][hetu_kelletube_plugin] provides
such APIs.

> Learn more about it in the [Kelletube Plugin API][kelletube_plugin_api] section

### The `.authStateStream` property

The `AuthEndpoint.authStateStream` property is also necessary to notify Kelletube about the authentication status. [`hetu_std`][hetu_std] is a built-in
...
Following events are respected by Kelletube:
...
methods Kelletube calls in its lifecycle.
...
| ------------------- | ------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------- |
| `me()`              | Fetches the current user's information.                                  | [`KelletubeUserObject`][KelletubeUserObject]                                                                                         |
| `savedTracks()`     | Fetches the user's saved tracks with pagination support.                 | [`KelletubePaginationResponseObject`][KelletubePaginationResponseObject] of [`KelletubeFullTrackObject`][KelletubeFullTrackObject]       |
| `savedPlaylists()`  | Fetches the user's saved playlists with pagination support.              | [`KelletubePaginationResponseObject`][KelletubePaginationResponseObject] of [`KelletubeFullPlaylistObject`][KelletubeFullPlaylistObject] |
| `savedAlbums()`     | Fetches the user's saved albums with pagination support.                 | [`KelletubePaginationResponseObject`][KelletubePaginationResponseObject] of [`KelletubeFullAlbumObject`][KelletubeFullAlbumObject]       |
| `savedArtists()`    | Fetches the user's saved artists with pagination support.                | [`KelletubePaginationResponseObject`][KelletubePaginationResponseObject] of [`KelletubeFullArtistObject`][KelletubeFullArtistObject]     |
...
| Method       | Description                                                                          | Returns                                                  |
| ------------ | ------------------------------------------------------------------------------------ | -------------------------------------------------------- |
| `getTrack()` | Fetches track information by ID.                                                     | [KelletubeFullTrackObject][KelletubeFullTrackObject]         |
...
| `radio()`    | Fetches related tracks based on specified tracks. Try to return a List of 50 tracks. | [List\<KelletubeFullTrackObject\>][KelletubeFullTrackObject] |
...
| Method       | Description                                                                              | Returns                                                                                                                    |
| ------------ | ---------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `getAlbum()` | Fetches album information by ID.                                                         | [`KelletubeFullAlbumObject`][KelletubeFullAlbumObject]                                                                         |
| `tracks()`   | Fetches tracks of the specified album. Accepts an ID and optional pagination parameters. | [`KelletubePaginationResponseObject`][KelletubePaginationResponseObject] of [`KelletubeFullTrackObject`][KelletubeFullTrackObject] |
| `releases()` | Fetches new album releases user followed artists or globally                             | [`KelletubePaginationResponseObject`][KelletubePaginationResponseObject] of [`KelletubeFullAlbumObject`][KelletubeFullAlbumObject] |
...
| Method        | Description                                                                            | Returns                                                                                                                      |
| ------------- | -------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `getArtist()` | Fetches artist information by ID.                                                      | [`KelletubeFullArtistObject`][KelletubeFullArtistObject]                                                                         |
| `related()`   | Fetches related artists based on the specified artist ID. Accepts optional pagination. | [`KelletubePaginationResponseObject`][KelletubePaginationResponseObject] of [`KelletubeFullArtistObject`][KelletubeFullArtistObject] |
| `topTracks()` | Fetches top tracks of the specified artist. Accepts optional pagination.               | [`KelletubePaginationResponseObject`][KelletubePaginationResponseObject] of [`KelletubeFullTrackObject`][KelletubeFullTrackObject]   |
| `albums()`    | Fetches albums of the specified artist. Accepts optional pagination.                   | [`KelletubePaginationResponseObject`][KelletubePaginationResponseObject] of [`KelletubeFullAlbumObject`][KelletubeFullAlbumObject]   |
...
| Method           | Description                                 | Returns                                                                                                                    |
| ---------------- | ------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `getPlaylist`    | Fetches a playlist by its ID.               | [`KelletubeFullPlaylistObject`][KelletubeFullPlaylistObject]                                                                   |
| `tracks`         | Fetches tracks in a playlist.               | [`KelletubePaginationResponseObject`][KelletubePaginationResponseObject] of [`KelletubeFullTrackObject`][KelletubeFullTrackObject] |
| `create`         | Creates a new playlist and returns          | [`KelletubeFullPlaylistObject`][KelletubeFullPlaylistObject]                                                                   |
...
| `all()`       | Searches for all types of content.  | [`KelletubeSearchResponseObject`][KelletubeSearchResponseObject]                                                                     |
| `albums()`    | Searches only for albums.           | [`KelletubePaginationResponseObject`][KelletubePaginationResponseObject] of [`KelletubeFullAlbumObject`][KelletubeFullAlbumObject]       |
| `artists()`   | Searches only for artists.          | [`KelletubePaginationResponseObject`][KelletubePaginationResponseObject] of [`KelletubeFullArtistObject`][KelletubeFullArtistObject]     |
| `tracks()`    | Searches only for tracks.           | [`KelletubePaginationResponseObject`][KelletubePaginationResponseObject] of [`KelletubeFullTrackObject`][KelletubeFullTrackObject]       |
| `playlists()` | Searches only for playlists.        | [`KelletubePaginationResponseObject`][KelletubePaginationResponseObject] of [`KelletubeFullPlaylistObject`][KelletubeFullPlaylistObject] |
...
| Method           | Description                              | Returns                                                                                                                                        |
| ---------------- | ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| `sections()`     | Returns the sections of the home page.   | [`KelletubePaginationResponseObject`][KelletubePaginationResponseObject] of [`KelletubeBrowseSectionObject`][KelletubeBrowseSectionObject] of `Object` |
| `sectionItems()` | Returns the items of a specific section. | [`KelletubePaginationResponseObject`][KelletubePaginationResponseObject] of `Object`                                                               |
...
[kelletube_plugin_api]: /docs/plugin-apis
[KelletubeUserObject]: /docs/reference/models#user
[KelletubePaginationResponseObject]: /docs/reference/models#pagination-response
[KelletubeFullAlbumObject]: /docs/reference/models#spotubefullalbumobject
[KelletubeFullArtistObject]: /docs/reference/models#spotubefullartistobject
[KelletubeFullTrackObject]: /docs/reference/models#track
[KelletubeFullPlaylistObject]: /docs/reference/models#spotubefullplaylistobject
[KelletubeSearchResponseObject]: /docs/reference/models#search-response
[KelletubeBrowseSectionObject]: /docs/reference/models#browse-section
