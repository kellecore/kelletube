...
[kelletube-plugin-template][kelletube-plugin-template] is a template repository for Kelletube plugins. It's a starting point
...
```bash
$ git clone https://github.com/KRTirtho/kelletube-plugin-template.git
$ cd kelletube-plugin-template
```

## Understanding plugins.json

After cloning the repository, you will find a file named `plugins.json` in the root directory.
This file is crucial for Kelletube to recognize your plugin. It looks like this:
...
```json
{
  ...
  "repository": "https://github.com/KRTirtho/kelletube-plugin-template",
...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `type`             | The type of the plugin, which is always `metadata` for Kelletube plugins.                                                                                                     |
...
| `pluginApiVersion` | The version of the plugin API that the plugin uses. This is used to determine if the plugin is compatible with the current version of Kelletube.                              |
...
Kelletube would call on your plugin. You can run this app to test your plugin's functionality.
...
{/* Links */}
[kelletube-plugin-template]: https://github.com/KRTirtho/kelletube-plugin-template
