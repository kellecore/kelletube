...
title: Introduction
description: Learn how to develop plugins for Kelletube
order: 0
---

Plugins in Kelletube are used for fetching metadata (Playlist, Album, Artist, Track Info, Search etc) and scrobbling. It gives developers
access to Kelletube's internal APIs to create custom metadata providers and audio [scrobblers][scrobbler_wiki].
...
To develop plugins for Kelletube, you need to have the following requirements:

- Basic programming knowledge
- [Dart][dart] and [Flutter][flutter] knowledge
- [Visual Studio Code][vscode] or any other code editor

Kelletube uses [hetu_script][hetu_script_link]. It's kind of similar to Typescript.
...
However, we created some helpful libraries to aid with Kelletube plugin development. The [hetu-community][hetu_community] is a
...
- [**KRTirtho/hetu_kelletube_plugin**][hetu_kelletube_plugin]: A library for Kelletube plugin development. It provides access to Kelletube's internal APIs
