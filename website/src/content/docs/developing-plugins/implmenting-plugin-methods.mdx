...
description: Tutorial on how to implement methods in your Kelletube plugin.
order: 2
---

In the previous section, you learned how to create a plugin project and run the example app.
In this section, you will learn how to implement methods in your Kelletube plugin.
...
that Kelletube will instantiate when it loads your plugin. You can pretty much keep this class same as the template, unless you
...
class TemplateMetadataProviderPlugin {
  // These are required properties that Kelletube will use to call the methods.
...
classes that contains methods that Kelletube calls. All of them are in `src/segments` folder
