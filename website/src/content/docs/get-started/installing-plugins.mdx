...
description: Learn how to install and manage plugins in Kelletube
order: 1
---

Let's first learn how to install plugins in Kelletube. It's pretty simple.

1. Open Kelletube (duh!)
1. Go to Settings
...
Usually, Kelletube will list public repositories of plugins from github and codeberg in the _Available plugins_ section.
