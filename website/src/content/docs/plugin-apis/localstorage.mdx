...
title: LocalStorage
description: Documentation for the LocalStorage API for kelletube plugins
order: 2
---

The `LocalStorage` API is a plain text key/value holding persistent storage for kelletube plugins. It's similar to the `localStorage` API in web browsers.
...
var LocalStorage = kelletube.LocalStorage
