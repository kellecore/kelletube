...
class MetadataPluginSavedPlaylistsNotifier
    extends PaginatedAsyncNotifier<KelletubeSimplePlaylistObject> {
  ...
  void updatePlaylist(KelletubeSimplePlaylistObject playlist) {
  ...
  Future<void> addFavorite(KelletubeSimplePlaylistObject playlist) async {
    if (state.value == null) return;
  ...
  Future<void> removeFavorite(KelletubeSimplePlaylistObject playlist) async {
    if (state.value == null) return;
