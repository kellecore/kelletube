...
class PlaybackHistoryActions {
  ...
  Future<void> addPlaylists(List<KelletubeSimplePlaylistObject> playlists) async {
  ...
  Future<void> addAlbums(List<KelletubeSimpleAlbumObject> albums) async {
    await _batchInsertHistoryEntries([
  ...
  Future<void> addTracks(List<KelletubeTrackObject> tracks) async {
    assert(
