...
class ScrobblerNotifier extends AsyncNotifier<Scrobblenaut?> {
  final StreamController<KelletubeTrackObject> _scrobbleController =
      StreamController<KelletubeTrackObject>.broadcast();
  @override
  build() async {
  ...
  Future<void> love(KelletubeTrackObject track) async {
  ...
  Future<void> unlove(KelletubeTrackObject track) async {
