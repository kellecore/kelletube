...
final localTracksProvider =
    FutureProvider<Map<String, List<KelletubeLocalTrackObject>>>((ref) async {
  try {
    if (kIsWeb) return {};
    final Map<String, List<KelletubeLocalTrackObject>> libraryToTracks = {};
    ...
    for (final location in [
      ...
      final tracksFromMetadata = filesWithMetadata
          .map(
            (fileWithMetadata) => KelletubeTrackObject.localTrackFromFile(
              fileWithMetadata.file,
              metadata: fileWithMetadata.metadata,
              art: fileWithMetadata.art,
            ) as KelletubeLocalTrackObject,
          )
          .toList();
