...
class PaginationProps {
  ...
  final Future<List<KelletubeFullTrackObject>> Function() onFetchAll;
...
class TrackPresentationOptions {
  ...
  final List<KelletubeFullTrackObject> tracks;
  ...
  const TrackPresentationOptions({
    ...
    this.onHeart,
    this.error,
  }) : assert(collection is KelletubeSimpleAlbumObject ||
            collection is KelletubeSimplePlaylistObject);

  String get collectionId => collection is KelletubeSimpleAlbumObject
      ? (collection as KelletubeSimpleAlbumObject).id
      : (collection as KelletubeSimplePlaylistObject).id;
