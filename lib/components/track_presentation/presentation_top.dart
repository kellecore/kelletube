...
import 'package:kelletube/components/track_presentation/use_action_callbacks.dart';
import 'package:kelletube/components/track_presentation/use_is_user_playlist.dart';
import 'package:kelletube/extensions/constrains.dart';
import 'package:kelletube/extensions/context.dart';
import 'package:kelletube/modules/playlist/playlist_create_dialog.dart';
    ...
    final playbackActions = Row(
      ...
      children: [
        Tooltip(
          ...
          child: IconButton.secondary(
            icon: isLoading
                ...
                : const Icon(KelletubeIcons.shuffle),
        ...
        if (mediaQuery.width <= 320)
          ...
          Button.secondary(
            leading: const Icon(KelletubeIcons.add),
            enabled: !isLoading && !isActive,
            onPressed: onAddToQueue,
        ...
        if (options.shareUrl != null)
          Tooltip(
            ...
            child: IconButton.outline(
              icon: const Icon(KelletubeIcons.share),
              size: ButtonSize.small,
              onPressed: () async {
