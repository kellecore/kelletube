...
class $PreferencesTableTable extends PreferencesTable
  ...
  @override
  late final GeneratedColumnWithTypeConverter<KelletubeColor, String>
  ...
  static TypeConverter<KelletubeColor, String> $converteraccentColorScheme =
...
class PreferencesTableData extends DataClass
  ...
  final KelletubeColor accentColorScheme;
  ...
  factory PreferencesTableData.fromJson(Map<String, dynamic> json,
    ...
    return PreferencesTableData(
      ...
      accentColorScheme:
          serializer.fromJson<KelletubeColor>(json['accentColorScheme']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'accentColorScheme': serializer.toJson<KelletubeColor>(accentColorScheme),
  ...
  PreferencesTableData copyWith(
          ...
          KelletubeColor? accentColorScheme,
...
class PreferencesTableCompanion extends UpdateCompanion<PreferencesTableData> {
  ...
  final Value<KelletubeColor> accentColorScheme;
  ...
  PreferencesTableCompanion copyWith(
      ...
      Value<KelletubeColor>? accentColorScheme,
...
class $AudioPlayerStateTableTable extends AudioPlayerStateTable
  ...
  @override
  late final GeneratedColumnWithTypeConverter<List<KelletubeTrackObject>, String>
      tracks = GeneratedColumn<String>('tracks', aliasedName, false,
              type: DriftSqlType.string,
              requiredDuringInsert: false,
              defaultValue: const Constant("[]"))
          .withConverter<List<KelletubeTrackObject>>(
  ...
  static TypeConverter<List<String>, String> $convertercollections =
      const StringListConverter();
  static TypeConverter<List<KelletubeTrackObject>, String> $convertertracks =
...
class AudioPlayerStateTableData extends DataClass
  ...
  final List<KelletubeTrackObject> tracks;
  ...
  factory AudioPlayerStateTableData.fromJson(Map<String, dynamic> json,
    ...
    return AudioPlayerStateTableData(
      ...
      tracks: serializer.fromJson<List<KelletubeTrackObject>>(json['tracks']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'tracks': serializer.toJson<List<KelletubeTrackObject>>(tracks),
  ...
  AudioPlayerStateTableData copyWith(
          ...
          List<KelletubeTrackObject>? tracks,
          int? currentIndex}) =>
...
class AudioPlayerStateTableCompanion
  ...
  final Value<List<KelletubeTrackObject>> tracks;
  ...
  AudioPlayerStateTableCompanion copyWith(
      ...
      Value<List<KelletubeTrackObject>>? tracks,
...
class $$PreferencesTableTableFilterComposer
  ...
  ColumnWithTypeConverterFilters<KelletubeColor, KelletubeColor, String>
...
class $$PreferencesTableTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<KelletubeColor, String>
      get accentColorScheme => $composableBuilder(
  ...
  $$PreferencesTableTableTableManager(
      ...
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<KelletubeColor> accentColorScheme = const Value.absent(),
...
class $$AudioPlayerStateTableTableFilterComposer
  ...
  ColumnWithTypeConverterFilters<List<KelletubeTrackObject>,
          List<KelletubeTrackObject>, String>
...
class $$AudioPlayerStateTableTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<List<KelletubeTrackObject>, String>
      get tracks => $composableBuilder(
  ...
  $$AudioPlayerStateTableTableTableManager(
      ...
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<List<KelletubeTrackObject>> tracks = const Value.absent(),
