...
class WebSocketAddTrackEvent extends WebSocketEvent<KelletubeFullTrackObject> {
  WebSocketAddTrackEvent(KelletubeFullTrackObject data)
      : super(WsEvent.addTrack, data);

  WebSocketAddTrackEvent.fromJson(Map<String, dynamic> json)
      : super(
          WsEvent.addTrack,
          KelletubeFullTrackObject.fromJson(
