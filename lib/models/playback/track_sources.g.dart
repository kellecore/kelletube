...
BasicSourcedTrack _$BasicSourcedTrackFromJson(Map json) => BasicSourcedTrack(
      query: KelletubeFullTrackObject.fromJson(
          Map<String, dynamic>.from(json['query'] as Map)),
      source: json['source'] as String,
      info: KelletubeAudioSourceMatchObject.fromJson(
          Map<String, dynamic>.from(json['info'] as Map)),
      sources: (json['sources'] as List<dynamic>)
          .map((e) => KelletubeAudioSourceStreamObject.fromJson(
              Map<String, dynamic>.from(e as Map)))
          .toList(),
      siblings: (json['siblings'] as List<dynamic>?)
              ?.map((e) => KelletubeAudioSourceMatchObject.fromJson(
                  Map<String, dynamic>.from(e as Map)))
              .toList() ??
          const [],
    );
