...
import 'package:kelletube/modules/lyrics/zoom_controls.dart';
import 'package:kelletube/components/shimmers/shimmer_lyrics.dart';
...
import 'package:kelletube/modules/lyrics/use_synced_lyrics.dart';
import 'package:scroll_to_index/scroll_to_index.dart';
import 'package:kelletube/provider/audio_player/audio_player.dart';
import 'package:kelletube/provider/lyrics/synced.dart';
          ...
          slivers: [
            ...
            if (playlist.activeTrack != null &&
              ...
              const SliverToBoxAdapter(
                child: Icon(KelletubeIcons.noLyrics, size: 60),
              ),
          ...
          child: Builder(builder: (context) {
            final actions = [
              ZoomControls(
                ...
                interval: 1,
                unit: "s",
                increaseIcon: const Icon(KelletubeIcons.add),
                decreaseIcon: const Icon(KelletubeIcons.remove),
