...
import 'package:kelletube/components/playbutton_view/playbutton_card.dart';
import 'package:kelletube/components/waypoint.dart';
...
import 'package:kelletube/provider/metadata_plugin/browse/section_items.dart';
...
class HomeBrowseSectionItemsPage extends HookConsumerWidget {
  ...
  final KelletubeBrowseSectionObject<Object> section;
              ...
              slivers: [
                SliverGrid.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return switch (item) {
                      KelletubeFullArtistObject() => ArtistCard(item),
                      KelletubeSimplePlaylistObject() => PlaylistCard(item),
                      KelletubeSimpleAlbumObject() => AlbumCard(item),
                      _ => throw Exception(
