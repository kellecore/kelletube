...
class AppLocalizationsTr extends AppLocalizations {
  ...
  @override
  String get u_love_kelletube => 'Kelletube\'u sevdiğinizi biliyoruz';

  @override
  String get check_for_updates => 'Güncellemeleri kontrol et';

  @override
  String get about_kelletube => 'Kelletube hakkında';
  ...
  String get kelletube_description =>
      'Kelletube, hafif, platformlar arası uyumlu ve herkes için ücretsiz bir Spotify istemcisidir.';
  ...
  String get download_ip_ban_warning =>
      'Ayrıca, normalden fazla indirme istekleri nedeniyle YouTube\'da IP\'niz engellenebilir. IP engeli, en az 2-3 ay boyunca YouTube\'u (hatta oturum açmış olsanız bile) o IP cihazından kullanamayacağınız anlamına gelir. Ve eğer böyle bir durum yaşanırsa, Kelletube bundan hiçbir sorumluluk kabul etmez.';
  ...
  String get download_agreement_3 =>
      'YouTube\'da IP\'min engellenebileceğinin tamamen farkındayım ve mevcut eylemlerimden kaynaklanan herhangi bir kaza için Kelletube\'u veya sahiplerini/katkıda bulunanları sorumlu tutmuyorum.';
  ...
  String get encryption_failed_warning =>
      'Kelletube, verilerinizi güvenli bir şekilde depolamak için şifreleme kullanır. Ancak bunu başaramadı. Bu nedenle, güvensiz depolamaya geri dönecektir\nLinux kullanıyorsanız, lütfen gnome-keyring, kde-wallet, keepassxc vb. herhangi bir gizli servisin yüklü olduğundan emin olun.';
  ...
  String get choose_your_region_description =>
      'Bu, Kelletube\'un konumunuza uygun içerikleri göstermesine yardımcı olacaktır.';
  ...
  String get help_project_grow_description =>
      'Kelletube açık kaynaklı bir projedir. Projeye katkıda bulunarak, hataları bildirerek veya yeni özellikler önererek bu projenin büyümesine yardımcı olabilirsiniz.';
  ...
  String get enable_connect_description =>
      'Kelletube\'u diğer cihazlardan kontrol edin';
  ...
  @override
  String get kelletube_has_an_update => 'Kelletube bir güncelleme aldı';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Kelletube Nightly $nightlyBuildNum yayımlandı';
  }

  @override
  String release_version(Object version) {
    return 'Kelletube v$version yayımlandı';
  }
