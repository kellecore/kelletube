...
class AppLocalizationsTh extends AppLocalizations {
  ...
  @override
  String get u_love_kelletube => 'เรารู้ว่าคุณรัก Kelletube';

  @override
  String get check_for_updates => 'ตรวจสอบการปรับปรุง';

  @override
  String get about_kelletube => 'เกี่ยวกับ Kelletube';
  ...
  String get kelletube_description =>
      'Kelletube โปรแกรมเล่น Spotify ฟรีสำหรับทุกคน น้ำหนักเบา รองรับหลายแพลตฟอร์ม';
  ...
  String get download_ip_ban_warning =>
      'นอกเหนือจากนั้น IP ของคุณอาจถูกบล็อกบน YouTube เนื่องจากคำขอดาวน์โหลดมากเกินกว่าปกติ การบล็อก IP หมายความว่าคุณไม่สามารถใช้ YouTube (แม้ว่าคุณจะล็อกอินอยู่) เป็นเวลาอย่างน้อย 2-3 เดือนจากอุปกรณ์ IP นั้น และ Kelletube จะไม่รับผิดชอบใด ๆ หากสิ่งนี้เกิดขึ้น';
  ...
  String get download_agreement_3 =>
      'ฉันรับทราบอย่างสมบูรณ์ว่า IP ของฉันอาจถูกบล็อกบน YouTube และฉันจะไม่ถือ Kelletube หรือเจ้าของ/ผู้มีส่วนร่วมใด ๆ รับผิดชอบต่ออุบัติเหตุใด ๆ ที่เกิดจากการกระทำปัจจุบันของฉัน';
  ...
  String get encryption_failed_warning =>
      'Kelletube ใช้การเข้ารหัสเพื่อเก็บข้อมูลของคุณอย่างปลอดภัย แต่ไม่สามารถทำได้ ดังนั้นจะเปลี่ยนเป็นการจัดเก็บที่ไม่ปลอดภัย\nหากคุณใช้ Linux โปรดตรวจสอบว่าคุณได้ติดตั้งบริการลับ (gnome-keyring, kde-wallet, keepassxc เป็นต้น)';
  ...
  String get choose_your_region_description =>
      'สิ่งนี้จะช่วยให้ Kelletube แสดงเนื้อหาที่เหมาะสมสำหรับคุณ';
  ...
  String get help_project_grow_description =>
      'Kelletube เป็นโครงการโอเพนซอร์ส คุณสามารถช่วยให้โครงการนี้เติบโตได้โดยการมีส่วนร่วมในโครงการ รายงานข้อบกพร่อง หรือเสนอคุณสมบัติใหม่';
  ...
  @override
  String get enable_connect_description => 'ควบคุม Kelletube จากอุปกรณ์อื่น';
  ...
  @override
  String get kelletube_has_an_update => 'Kelletube มีการอัปเดต';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Kelletube Nightly $nightlyBuildNum ได้รับการปล่อยออกมา';
  }

  @override
  String release_version(Object version) {
    return 'Kelletube v$version ได้รับการปล่อยออกมา';
  }
