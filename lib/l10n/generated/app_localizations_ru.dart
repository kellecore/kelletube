...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get u_love_kelletube => 'Мы знаем что вам нравится Kelletube';

  @override
  String get check_for_updates => 'Проверьте наличие обновлений';

  @override
  String get about_kelletube => 'О Kelletube';
  ...
  String get kelletube_description =>
      'Kelletube – это легкий, кросс-платформенный клиент Spotify, предоставляющий бесплатный доступ для всех пользователей';
  ...
  String get download_agreement_3 =>
      'Я полностью осознаю, что мой IP-адрес может быть заблокирован на YouTube, и я не считаю Kelletube или его владельцев/соавторов ответственными за какие-либо неприятности, вызванные моими текущими действиями';
  ...
  String get encryption_failed_warning =>
      'Kelletube использует шифрование для безопасного хранения ваших данных. Однако в этом случае произошла ошибка. Поэтому будет использовано небезопасное хранилище.\nЕсли вы используете Linux, убедитесь, что у вас установлен какой-либо инструмент для работы с секретами (gnome-keyring, kde-wallet, keepassxc и т.д.)';
  ...
  String get choose_your_region_description =>
      'Это поможет Kelletube показать вам правильный контент\nдля вашего местоположения.';
  ...
  String get help_project_grow_description =>
      'Kelletube - это проект с открытым исходным кодом. Вы можете помочь этому проекту развиваться, внося вклад в проект, сообщая ошибках или предлагая новые функции.';
  ...
  String get enable_connect_description =>
      'Управление Kelletube с других устройств';
  ...
  @override
  String get kelletube_has_an_update => 'В Kelletube доступно обновление';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Kelletube Nightly $nightlyBuildNum выпущен';
  }

  @override
  String release_version(Object version) {
    return 'Kelletube v$version выпущен';
  }
