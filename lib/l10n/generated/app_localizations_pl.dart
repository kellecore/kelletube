...
class AppLocalizationsPl extends AppLocalizations {
  ...
  @override
  String get u_love_kelletube => 'Wiemy jak kochacie Kelletube';

  @override
  String get check_for_updates => 'Sprawdź aktualizacje';

  @override
  String get about_kelletube => 'O Kelletube';
  ...
  String get kelletube_description =>
      'Kelletube, lekki, wieloplatformowy, darmowy dla wszystkich klient Spotify';
  ...
  String get download_ip_ban_warning =>
      'Przy okazji, Twój adres IP może zostać zablokowany w YouTube z powodu nadmiernych żądań pobierania niż zwykle. Blokada IP oznacza, że nie możesz korzystać z YouTube (nawet jeśli jesteś zalogowany) przez co najmniej 2-3 miesiące z IP tego urządzenia. Kelletube nie ponosi żadnej odpowiedzialności, jeśli tak się stanie';
  ...
  String get download_agreement_3 =>
      'Jestem całkowicie świadomy, że moje IP może zostać zablokowane w YouTube i nie pociągam Kelletube ani jego właścicieli/współtwórców do odpowiedzialności za jakiekolwiek wypadki spowodowane moimi obecnymi działaniami';
  ...
  String get encryption_failed_warning =>
      'Kelletube używa szyfrowania do bezpiecznego przechowywania danych. Ale nie udało się tego zrobić. Więc powróci do niezabezpieczonego przechowywania\nJeśli używasz Linuksa, upewnij się, że masz zainstalowane jakieś usługi do szyfrowania (gnome-keyring, kde-wallet, keepassxc itp.)';
  ...
  String get choose_your_region_description =>
      'To pomoże Kelletube pokazać Ci odpowiednią treść dla Twojej lokalizacji.';
  ...
  String get help_project_grow_description =>
      'Kelletube to projekt open-source. Możesz pomóc temu projektowi rosnąć, przyczyniając się do projektu, zgłaszając błędy lub sugerując nowe funkcje.';
  ...
  String get enable_connect_description =>
      'Kontroluj Kelletube z innych urządzeń';
  ...
  @override
  String get kelletube_has_an_update => 'Kelletube ma aktualizację';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Kelletube Nightly $nightlyBuildNum został wydany';
  }

  @override
  String release_version(Object version) {
    return 'Kelletube v$version został wydany';
  }
