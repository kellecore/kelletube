...
class AppLocalizationsBn extends AppLocalizations {
  ...
  @override
  String get u_love_kelletube => 'আমরা জানি আপনি Kelletube কে ভালবাসেন';

  @override
  String get check_for_updates => 'আপডেট চেক করুন';

  @override
  String get about_kelletube => 'Kelletube সম্পর্কে বিস্তারিত';
  ...
  String get kelletube_description =>
      'Kelletube, একটি কর্মদক্ষ, ক্রস-প্ল্যাটফর্ম, বিনামূল্যের জন্য Spotify ক্লায়েন্ট';
  ...
  String get download_ip_ban_warning =>
      'তথ্যবিশ্বস্ত করে নেওয়া যায় যে, আপনার IP ঠিকানাটি YouTube দ্বারা স্থানান্তরিত করা হতে পারে যখন সাধারন থেকে বেশি ডাউনলোড অনুরোধ হয়। IP ব্লকের মাধ্যমে আপনি কমপক্ষে ২-৩ মাস ধরে (ঐ IP ডিভাইস থেকে) YouTube ব্যবহার করতে পারবেন না। এবং Kelletube কোনও দায়িত্ব সম্পর্কে দায়িত্ব বহন করে না যদি এটি ঘটে।';
  ...
  String get download_agreement_3 =>
      'আমি সম্পূর্ণরূপে জানি যে আমার IP YouTube-তে ব্লক হতে পারে এবং আমি Kelletube বা তার মালিকানাধীন কোনও দায়িত্ব পেতে পারিনি আমার বর্তমান ক্রিয়াটি দ্বারা সৃষ্ট দুর্ঘটনা করার জন্য';
  ...
  String get enable_connect_description =>
      'অন্যান্য ডিভাইস থেকে Kelletube নিয়ন্ত্রণ করুন';
  ...
  @override
  String get kelletube_has_an_update => 'স্পটিউবে একটি আপডেট আছে';
