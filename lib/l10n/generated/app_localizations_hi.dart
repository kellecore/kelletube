...
class AppLocalizationsHi extends AppLocalizations {
  ...
  @override
  String get u_love_kelletube => 'हम जानते हैं कि आप Kelletube से प्यार करते हैं';

  @override
  String get check_for_updates => 'अपडेट के लिए जाँच करें';

  @override
  String get about_kelletube => 'Kelletube के बारे में';
  ...
  String get kelletube_description =>
      'Kelletube, एक हल्का, सभी प्लेटफॉर्मों पर चलने वाला, मुफ्त स्पॉटिफाई क्लाइंट';
  ...
  String get encryption_failed_warning =>
      'Kelletube आपके डेटा को सुरक्षित रूप से स्टोर करने के लिए एन्क्रिप्शन का उपयोग करता है। लेकिन इसमें विफल रहा। इसलिए, यह असुरक्षित स्टोरेज पर फॉलबैक करेगा\nयदि आप Linux का उपयोग कर रहे हैं, तो कृपया सुनिश्चित करें कि आपके पास gnome-keyring, kde-wallet, keepassxc आदि जैसी कोई सीक्रेट-सर्विस इंस्टॉल की गई है';
  ...
  String get choose_your_region_description =>
      'यह Kelletube को आपके स्थान के लिए सही सामग्री दिखाने में मदद करेगा।';
  ...
  String get help_project_grow_description =>
      'Kelletube एक ओपन सोर्स परियोजना है। आप इस परियोजना को योगदान देकर, बग रिपोर्ट करके या नई विशेषताओं का सुझाव देकर इस परियोजना को बढ़ा सकते हैं।';
  ...
  String get enable_connect_description =>
      'अन्य उपकरणों से Kelletube को नियंत्रित करें';
  ...
  @override
  String get kelletube_has_an_update => 'Kelletube में एक अपडेट है';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Kelletube Nightly $nightlyBuildNum जारी किया गया है';
  }

  @override
  String release_version(Object version) {
    return 'Kelletube v$version जारी किया गया है';
  }
