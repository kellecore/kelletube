...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get u_love_kelletube => 'نحن نعلم أنك تحب Kelletube';

  @override
  String get check_for_updates => 'تحقق من وجود تحديثات';

  @override
  String get about_kelletube => 'حول Kelletube';
  ...
  String get kelletube_description =>
      'Kelletube، عميل Spotify خفيف الوزن ومتعدد المنصات ومجاني للجميع';
  ...
  String get download_ip_ban_warning =>
      'بالمناسبة، يمكن أن يتم حظر عنوان IP الخاص بك على YouTube بسبب طلبات التنزيل الزائدة عن المعتاد. يعني حظر IP أنه لا يمكنك استخدام YouTube (حتى إذا قمت بتسجيل الدخول) لمدة تتراوح بين شهرين إلى ثلاثة أشهر على الأقل من جهاز IP هذا. ولا يتحمل Kelletube أي مسؤولية إذا حدث هذا على الإطلاق';
  ...
  String get download_agreement_3 =>
      'أدرك تمامًا أنه يمكن حظر عنوان IP الخاص بي على YouTube ولا أحمل Kelletube أو مالكيه/مساهميه المسؤولية عن أي حوادث ناجمة عن الإجراء الحالي الخاص بي';
  ...
  String get encryption_failed_warning =>
      'يستخدم Kelletube التشفير لتخزين بياناتك بشكل آمن. لكنها فشلت في القيام بذلك. لذلك سيعود الأمر إلى التخزين غير الآمن\nإذا كنت تستخدم Linux، فيرجى التأكد من تثبيت أي خدمة سرية (gnome-keyring، kde-wallet، keepassxc، إلخ)';
  ...
  String get help_project_grow_description =>
      'Kelletube هو مشروع مفتوح المصدر. يمكنك مساعدة هذا المشروع في النمو عن طريق المساهمة في المشروع، أو الإبلاغ عن الأخطاء، أو اقتراح ميزات جديدة.';
  ...
  String get enable_connect_description =>
      'التحكم في Kelletube من الأجهزة الأخرى';
  ...
  @override
  String get kelletube_has_an_update => 'يوجد تحديث لسبوتيوب';
