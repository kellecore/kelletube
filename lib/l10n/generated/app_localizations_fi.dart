...
class AppLocalizationsFi extends AppLocalizations {
  ...
  @override
  String get u_love_kelletube => 'Tiedämme että rakastat Kelletubea';

  @override
  String get check_for_updates => 'Tarkista päivitykset';

  @override
  String get about_kelletube => 'Tietoa Kelletube:sta';
  ...
  String get kelletube_description =>
      'Kelletube, kevyt, cross-platform, vapaa-kaikille spotify clientti';
  ...
  String get download_ip_ban_warning =>
      'BTW, YouTube voi estää IP-Osoitteesi tavallista liiallisten latauspyyntöjen takia. IP-Osoitteen esto tarkoittaa sitä, ettet voi käyttää YouTubea (vaikka olisit kirjautunut) vähintään 2-3kk aikana kyseiseltä laitteelta. Kelletube ei kanna yhtään vastuuta jos se tapahtuu.';
  ...
  String get download_agreement_3 =>
      'Ymmärrän että minun YouTube voi estää IP-Osoitteeni ja en pidä Kelletubea tai omistajiinsa/avustajia vastuullisena mistään omista teoistsani';
  ...
  String get encryption_failed_warning =>
      'Kelletube käyttää salausta tallentaakseen tietosi, mutta epäonnistui, joten se palaa epäturvalliseen tallennukseen\nJos käytät Linuxia, varmista että sinulla on turvallisuuspalvelu (gnome-keyring, kde-wallet, keepassxc jne) asennettu';
  ...
  String get choose_your_region_description =>
      'Tämä auttaa Kelletube näyttämään sinulle oikeaa sisältöä\nsijaintiasi varten.';
  ...
  String get help_project_grow_description =>
      'Kelletube projekti minkä lähdekoodi on julkisesti saatavilla. Voit autta tätä projektia kasvamaan muutoksilla, ilmoittamalla bugeista, tai ehdottamalla uusia ominaisuuksia.';
  ...
  @override
  String get enable_connect_description => 'Ohjaa Kelletubea toiselta laitteelta';
  ...
  @override
  String get kelletube_has_an_update => 'Kelletubella on päivitys';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Kelletube Nightly $nightlyBuildNum on julkaistu';
  }

  @override
  String release_version(Object version) {
    return 'Kelletube v$version on julkaistu';
  }
