...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get u_love_kelletube => 'Ми знаємо, що ви любите Kelletube';

  @override
  String get check_for_updates => 'Перевірити наявність оновлень';

  @override
  String get about_kelletube => 'Про Kelletube';
  ...
  String get kelletube_description =>
      'Kelletube, легкий, кросплатформовий, безкоштовний клієнт Spotify';
  ...
  String get download_agreement_3 =>
      'Я повністю усвідомлюю, що мій IP може бути заблокований на YouTube, і я не покладаю на Kelletube або його власників/контрибуторів відповідальність за будь-які нещасні випадки, спричинені моїми діями.';
  ...
  String get encryption_failed_warning =>
      'Kelletube використовує шифрування для безпечного зберігання ваших даних. Але не вдалося цього зробити. Тому він перейде до небезпечного зберігання\nЯкщо ви використовуєте Linux, переконайтеся, що у вас встановлено будь-який секретний сервіс (gnome-keyring, kde-wallet, keepassxc тощо)';
  ...
  String get choose_your_region_description =>
      'Це допоможе Kelletube показати вам правильний контент\nдля вашого місцезнаходження.';
  ...
  String get help_project_grow_description =>
      'Kelletube - це проект з відкритим кодом. Ви можете допомогти цьому проекту зростати, вносячи свій внесок у проект, повідомляючи про помилки або пропонуючи нові функції.';
  ...
  @override
  String get enable_connect_description => 'Керуйте Kelletube з інших пристроїв';
  ...
  @override
  String get kelletube_has_an_update => 'Kelletube має оновлення';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Kelletube Nightly $nightlyBuildNum було випущено';
  }

  @override
  String release_version(Object version) {
    return 'Kelletube v$version було випущено';
  }
