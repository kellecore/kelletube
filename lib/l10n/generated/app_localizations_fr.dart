...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get u_love_kelletube => 'Nous savons que vous aimez Kelletube';

  @override
  String get check_for_updates => 'Vérifier les mises à jour';

  @override
  String get about_kelletube => 'À propos de Kelletube';
  ...
  String get kelletube_description =>
      'Kelletube, un client Spotify léger, multiplateforme et gratuit pour tous';
  ...
  String get download_ip_ban_warning =>
      'Au fait, votre adresse IP peut être bloquée sur YouTube en raison d\'une demande excessive de téléchargements par rapport à la normale. Le blocage de l\'IP signifie que vous ne pourrez pas utiliser YouTube (même si vous êtes connecté) pendant au moins 2 à 3 mois à partir de cet appareil IP. Et Kelletube ne peut être tenu responsable si cela se produit.';
  ...
  String get download_agreement_3 =>
      'Je suis parfaitement conscient(e) que mon adresse IP peut être bloquée sur YouTube et je ne tiens pas Kelletube ni ses propriétaires/contributeurs responsables de tout accident causé par mon action actuelle.';
  ...
  String get encryption_failed_warning =>
      'Kelletube utilise le cryptage pour stocker vos données en toute sécurité. Mais cela a échoué. Il basculera donc vers un stockage non sécurisé\nSi vous utilisez Linux, assurez-vous d\'avoir installé des services secrets tels que gnome-keyring, kde-wallet et keepassxc';
  ...
  String get choose_your_region_description =>
      'Cela aidera Kelletube à vous montrer le bon contenu pour votre emplacement.';
  ...
  String get help_project_grow_description =>
      'Kelletube est un projet open-source. Vous pouvez aider ce projet à grandir en contribuant au projet, en signalant des bugs ou en suggérant de nouvelles fonctionnalités.';
  ...
  String get enable_connect_description =>
      'Contrôlez Kelletube depuis d\'autres appareils';
  ...
  @override
  String get kelletube_has_an_update => 'Kelletube a une mise à jour';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Kelletube Nightly $nightlyBuildNum a été publié';
  }

  @override
  String release_version(Object version) {
    return 'Kelletube v$version a été publié';
  }
