...
abstract class AppLocalizations {
  ...
  /// No description provided for @u_love_kelletube.
  ///
  /// In en, this message translates to:
  /// **'We know you love Kelletube'**
  String get u_love_kelletube;
  ...
  /// No description provided for @about_kelletube.
  ///
  /// In en, this message translates to:
  /// **'About Kelletube'**
  String get about_kelletube;
  ...
  /// No description provided for @kelletube_description.
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'BTW, your IP can get blocked on YouTube due excessive download requests than usual. IP block means you can\'t use YouTube (even if you\'re logged in) for at least 2-3 months from that IP device. And Kelletube doesn\'t hold any responsibility if this ever happens'**
  ...
  ///
  /// In en, this message translates to:
  /// **'I\'m completely aware that my IP can get blocked on YouTube & I don\'t hold Kelletube or his owners/contributors responsible for any accidents caused by my current action'**
  ...
  ///
  /// In en, this message translates to:
  /// **'This will help Kelletube show you the right content\nfor your location.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Kelletube is an open-source project. You can help this project grow by contributing to the project, reporting bugs, or suggesting new features.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Control Kelletube from other devices'**
  ...
  /// No description provided for @kelletube_has_an_update.
  ///
  /// In en, this message translates to:
  /// **'Kelletube has an update'**
  String get kelletube_has_an_update;
  ...
  ///
  /// In en, this message translates to:
  /// **'Kelletube Nightly {nightlyBuildNum} has been released'**
  String nightly_version(Object nightlyBuildNum);

  /// No description provided for @release_version.
  ///
  /// In en, this message translates to:
  /// **'Kelletube v{version} has been released'**
