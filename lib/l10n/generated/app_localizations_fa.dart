...
class AppLocalizationsFa extends AppLocalizations {
  ...
  @override
  String get u_love_kelletube => 'دوست داریدKelletubeما میدانیم شما ';

  @override
  String get check_for_updates => 'بروزرسانی را بررسی کنید';

  @override
  String get about_kelletube => 'Kelletube درباره';
  ...
  String get kelletube_description =>
      'یک برنامه سبک و مولتی پلتفرم و رایگان برای همه استKelletube';
  ...
  String get download_ip_ban_warning =>
      'راستی آی پی شما می تواند در یوتوب به دلیل درخواست های دانلود بیش از حد معمول مسدود شود. بلوک آی پی به این معنی است که شما نمی توانید از یوتوب (حتی اگر وارد سیستم شده باشید) حداقل 2-3 ماه از آن دستگاه آی پی استفاده کنید. و Kelletube هیچ مسئولیتی در صورت وقوع این اتفاق ندارد';
  ...
  String get encryption_failed_warning =>
      'Kelletube از رمزگذاری برای ذخیره ایمن داده های شما استفاده می کند. اما موفق به انجام این کار نشد. بنابراین به فضای ذخیره‌سازی ناامن تبدیل می‌شود\nاگر از لینوکس استفاده می‌کنید، لطفاً مطمئن شوید که سرویس مخفی (gnome-keyring، kde-wallet، keepassxc و غیره) را نصب کرده‌اید.';
  ...
  String get choose_your_region_description =>
      'این به Kelletube کمک می‌کند تا محتوای مناسبی را برای موقعیت شما نشان دهد.';
  ...
  String get help_project_grow_description =>
      'Kelletube یک پروژه متن باز است. شما می‌توانید با به پروژه کمک کردن، گزارش دادن اشکالات یا پیشنهاد ویژگی‌های جدید، به این پروژه کمک کنید.';
  ...
  @override
  String get enable_connect_description => 'کنترل Kelletube از دیگر دستگاه‌ها';
  ...
  @override
  String get kelletube_has_an_update => 'Kelletube یک بروزرسانی دارد';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'نسخه شبانه Kelletube $nightlyBuildNum منتشر شد';
  }

  @override
  String release_version(Object version) {
    return 'نسخه Kelletube v$version منتشر شد';
  }
