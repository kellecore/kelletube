...
class AppLocalizationsCa extends AppLocalizations {
  ...
  @override
  String get u_love_kelletube => 'Sabem que li encanta Kelletube';

  @override
  String get check_for_updates => 'Buscar actualitzacions';

  @override
  String get about_kelletube => 'Sobre Kelletube';
  ...
  String get kelletube_description =>
      'Kelletube, un client lleuger, multiplataforma i gratuït de Spotify';
  ...
  String get download_ip_ban_warning =>
      'Per cert, la seva IP pot ser bloquejada a YouTube degut a solicituds de descàrrega excessives. El bloqueig d\'IP vol dir que no podrà utilitzar YouTube (fins i tot si ha iniciat sessió) durant un mínim de 2-3 meses desde esa dirección IP. I Kelletube no es fa responsable si això succeeix en alguna ocasió';
  ...
  String get download_agreement_3 =>
      'Sóc completament conscient que la meva IP pot ser bloqueada per YouTube i no responsabilizo a Kelletube ni als seus propietaris/contribuents per qualsevol incident causat per la meva acció actual';
  ...
  String get encryption_failed_warning =>
      'Kelletube utilitza el xifrado per emmagatzemar les seves dades de forma segura. Però ha fallat. Per tant, tornarà a un emmagatzament no segur\nSi estè utilizant Linux, asseguri\'s de tenir instal·lats els serveis secrets com gnome-keyring, kde-wallet i keepassxc';
  ...
  String get choose_your_region_description =>
      'Això ajudarà a Kelletube a mostrar-vos el contingut adequat\nper a la vostra ubicació.';
  ...
  String get help_project_grow_description =>
      'Kelletube és un projecte de codi obert. Podeu ajudar a fer créixer aquest projecte contribuint al projecte, informant d\'errors o suggerint noves funcionalitats.';
  ...
  String get enable_connect_description =>
      'Controla Kelletube des d\'altres dispositius';
  ...
  @override
  String get kelletube_has_an_update => 'Kelletube té una actualització';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Kelletube Nightly $nightlyBuildNum ha estat publicat';
  }

  @override
  String release_version(Object version) {
    return 'Kelletube v$version ha estat publicat';
  }
