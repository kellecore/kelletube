...
class RootAppUpdateDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const url = "https://kelletube.krtirtho.dev/downloads";
    const nightlyUrl = "https://kelletube.krtirtho.dev/downloads/nightly";
    return AlertDialog(
      title: Text(context.l10n.kelletube_has_an_update),
      actions: [
        Button.primary(
