...
import 'package:kelletube/modules/player/player_overlay.dart';
import 'package:kelletube/modules/player/player_track_details.dart';
                ...
                extraActions: [
                  Tooltip(
                    ...
                    child: IconButton(
                      ...
                      icon: const Icon(KelletubeIcons.miniPlayer),
                      onPressed: () async {
