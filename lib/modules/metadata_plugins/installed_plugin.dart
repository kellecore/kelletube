...
import 'package:kelletube/modules/metadata_plugins/plugin_update_available_dialog.dart';
import 'package:kelletube/provider/metadata_plugin/core/auth.dart';
import 'package:kelletube/provider/metadata_plugin/core/support.dart';
...
final validAbilities = {
  PluginAbilities.metadata: ("Metadata", KelletubeIcons.album),
  PluginAbilities.audioSource: ("Audio Source", KelletubeIcons.music),
};
              ...
              return Basic(
                leading: snapshot.hasData
                    ...
                    : Container(
                        ...
                        child: const Icon(KelletubeIcons.plugin),
                      ),
                ...
                children: [
                  if (requiresAuth && !isAuthenticated)
                    Row(
                      spacing: 8,
                      children: [
                        const Icon(KelletubeIcons.warning, color: Colors.yellow),
                ...
                children: [
                  if (isDefaultMetadata || isDefaultAudioSource)
                    Consumer(builder: (context, ref, _) {
                      ...
                      return Button(
                        ...
                        leading: const Icon(KelletubeIcons.heartFilled),
                  ...
                  if ((isDefaultMetadata || isDefaultAudioSource) &&
                    ...
                    Button.primary(
                      ...
                      leading: const Icon(KelletubeIcons.login),
                    ...
                    Button.destructive(
                      ...
                      leading: const Icon(KelletubeIcons.logout),
