...
import 'package:kelletube/components/fallbacks/not_found.dart';
...
import 'package:kelletube/hooks/controllers/use_auto_scroll_controller.dart';
import 'package:kelletube/models/metadata/metadata.dart';
import 'package:kelletube/modules/player/player_queue_actions.dart';
...
class PlayerQueue extends HookConsumerWidget {
  ...
  final Future<void> Function(KelletubeTrackObject track) onJump;
                          ...
                          builder: (context, close) => Column(
                            ...
                            children: [
                              ...
                              ButtonTile(
                                ...
                                leading:
                                    const Icon(KelletubeIcons.selectionCheck),
                    ...
                    AppBar(
                      ...
                      trailing: [
                        if (mediaQuery.mdAndUp)
                          ...
                          IconButton.ghost(
                            icon: const Icon(KelletubeIcons.filter),
                            onPressed: () {
                        ...
                        if (!isSearching.value) ...[
                          ...
                          Tooltip(
                            ...
                            child: IconButton.outline(
                              icon: const Icon(KelletubeIcons.playlistRemove),
                              onPressed: () {
                                onStop();
                                closeDrawer(context);
                              },
                          ...
                          const Gap(5),
                          if (mediaQuery.smAndDown)
                            const BackButton(icon: KelletubeIcons.angleDown),
                        ],
                      ],
                    ),
                  const Divider(),
