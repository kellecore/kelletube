...
import 'package:kelletube/components/form/checkbox_form_field.dart';
...
import 'package:kelletube/provider/metadata_plugin/playlist/playlist.dart';
      ...
      try {
        ...
        if (context.mounted &&
            !ref
                ...
                .hasError) {
          context.router.maybePop<KelletubeFullPlaylistObject>(
            await ref
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Button.secondary(
                            leading: const Icon(KelletubeIcons.edit),
                            child: Text(
                          ...
                          IconButton.destructive(
                            icon: const Icon(KelletubeIcons.trash),
...
class PlaylistCreateDialogButton extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    return Button.secondary(
      leading: const Icon(KelletubeIcons.addFilled),
